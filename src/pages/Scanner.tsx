    ...
    useEffect(() => {
        if (hasPermission) {
            const timer = setTimeout(() => {
                setIsScanning(false);
                // Simulate navigating to a success or RVM pairing screen
            }, 5000);
    ...
    return (
        <div className="relative h-screen bg-black overflow-hidden flex flex-col items-center justify-center">
            ...
            {hasPermission === true ? (
                ...
                <div className="flex flex-col items-center justify-center text-white p-8 text-center space-y-4">
            ...
            {/* Scanning Focus Area - ABSOLUTELY CENTERED */}
            ...
            {/* UI Overlay */}
            <div className="absolute inset-x-0 top-0 p-8 flex items-center justify-between z-20">
                <button
                    onClick={() => navigate(-1)}
            ...
            <div className="absolute inset-x-0 bottom-24 text-center space-y-6 z-20 px-10">
                <div>
                ...
                <div className="flex justify-center">
                    <div className="w-20 h-20 bg-white/10 backdrop-blur-2xl rounded-full flex items-center justify-center border border-white/20 shadow-2xl animate-pulse">
